...
<div class="row left-shift">
	<div>
	  <h2>WildPHP</h2>
	      ...
	      <ul class="media-grid">
		  	<li><a href="http://wildphp.com"><img class="thumbnail" src="img/template/wildphp.png" alt="wildphp"></a></li>
		  </ul>
	      <p><a class="btn" href="http://wildphp.com">Visit &raquo;</a></p>
	  <h2>Nystic</h2>
	      <p>A large online community for <a href="http://blender.org">Blender</a>.</p>
	      <ul class="media-grid">
		  	<li><a href="http://forum.nystic.com"><img class="thumbnail" src="img/template/nystic.png" alt="nystic"></a></li>
		  </ul>
