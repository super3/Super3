...
<div class="row">
	...
	<div>
	    <div class="span4">
	        <h2>Sites</h2>
	        <?php thumbnail("span4", "sites", "view/images/template/sites.png"); ?>
	    ...
	    <div class="span4">
	        <h2>Tutorials</h2>
	        <?php thumbnail("span4", "tutorials", "view/images/template/tutorials.png"); ?>
	    ...
	    <div class="span4">
	        <h2>Code</h2>
	        <?php thumbnail("span4", "code", "view/images/template/code.png"); ?>
