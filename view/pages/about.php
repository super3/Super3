...
<div class="hero-unit">
	...
	<a href="http://www.youtube.com/user/super3boy"><img src="view/images/template/youtube.png" alt="youtube" class="right social"/></a>
	<a href="http://twitter.com/super3"><img src="view/images/template/twitter.png" alt="twitter" class="right social"></a>
	<a href="http://www.reddit.com/user/super3"><img src="view/images/template/reddit.png" alt="reddit" class="right social"></a>
	<h1>About</h1>
</div>
...
<div class="row">
    <div class="span12">
        <h2>About Me</h2>
        <?php thumbnail("span12", "#", "view/images/template/me.png"); ?>
        <p>
        ...
        <?php thumbnail("span12", "#", "view/images/template/wallthumb.png"); ?>
        <p>
